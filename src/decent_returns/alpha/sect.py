...
# ts_sign_sq_g1_lb126_hl63
lookbacks = [113, 139]
halflifes = [57, 69]
gammas = [0.9, 1.1]

# BEST : sect_ts_sign_sq_g1_lb252_hl252 (const) - 0.590
# BEST : sect_ts_raw_g100_lb63_hl63             - 0.699
    ...
    for lb in lookbacks:
        for hl in halflifes:
            ...
            for (tf_label, sign_sq, sign, rank) in transforms:
                ...
                alpha.to_parquet(
                    f"../../../data/processed/alphas/sect_ts_{tf_label}_g{g}_lb{lb}_hl{hl}.parquet"
                )
                print(f"sect_ts_{tf_label}_g{g}_lb{lb}_hl{hl}")
...
#                 alpha = alpha.fillna(0.0)
#                 alpha.to_parquet(
#                     f"../../../data/processed/alphas/sect_cs_{tf_label}_g{g}_lb{lb}_hl{hl}.parquet"
#                 )
#                 print(f"sect_cs_{tf_label}_g{g}_lb{lb}_hl{hl}")