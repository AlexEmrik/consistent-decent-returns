...
# BEST : gold_ts_raw_g100_lb252_hl63 (const) - 0.499
# BEST : gold_ts_raw_g1_lb63_hl63            - 0.476

# ts_raw_g100_lb126_hl126
lookbacks = [113, 139]
halflifes = [113, 139]
gammas = [90, 110]
    ...
    for lb in lookbacks:
        for hl in halflifes:
            ...
            for (tf_label, sign_sq, sign, rank) in transforms:
                ...
                alpha.to_parquet(
                    f"../../../data/processed/alphas/gold_ts_{tf_label}_g{g}_lb{lb}_hl{hl}.parquet"
                )
                print(f"gold_ts_{tf_label}_g{g}_lb{lb}_hl{hl}")
...
#                 alpha = alpha.fillna(0.0)
#                 alpha.to_parquet(
#                     f"../../../data/processed/alphas/gold_cs_{tf_label}_g{g}_lb{lb}_hl{hl}.parquet"
#                 )
#                 print(f"gold_cs_{tf_label}_g{g}_lb{lb}_hl{hl}")